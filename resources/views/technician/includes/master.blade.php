...
<head>
    ...
    <link rel="stylesheet" id="css-main" href="{{asset('assets/css/themes/default.min.css')}}">
            ...
            <div class="content-side">
                <ul class="nav-main">
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="{{route("technician.dashboard")}}">
                            <i class="nav-main-link-icon si si-speedometer"></i>
                            <span class="nav-main-link-name">Dashboard</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="{{route("technician.sla.create")}}">
                            <i class="nav-main-link-icon far fa-square-plus"></i>
                            <span class="nav-main-link-name">Create SLA</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="{{route("technician.slas")}}">
                            <i class="nav-main-link-icon far fa-rectangle-list"></i>
                            <span class="nav-main-link-name">Your SLAs</span>
                        </a>
                    </li>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 border-0 fs-sm" aria-labelledby="page-header-notifications-dropdown">
                        ...
                        <ul class="nav-items mb-0">
                            ...
                            <li >
                                ...
                                <a class="text-dark d-flex py-2 bg-modern-lighter unread-notif" href="{{ route("technician.workorders.details",['id'=>$items['data']['work_id']]) }}">
                            ...
                            @endforeach
                                ...
                                @foreach(auth()->user()->notifications->slice(0, 5) as $items)

                                    @if($items['read_at']!=null)
                                    <li >

                                        <a class="text-dark d-flex py-2 " href="{{ route("technician.workorders.details",['id'=>$items['data']['work_id']]) }}">
                                            <div class="flex-shrink-0 me-2 ms-3">
                                                <i class="fa fa-fw fa-plus-circle text-primary"></i>
                                            </div>
                                            <div class="flex-grow-1 pe-2">
