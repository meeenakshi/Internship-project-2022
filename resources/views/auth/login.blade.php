        ...
        <div class="hero-static d-flex align-items-center">
            <div class="content">
                        ...
                        <div class="block block-rounded mb-0">
                            ...
                            <div class="block-content">
                                <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
                                    <h1 class="h2 mb-1">Cybernaptics</h1>
                                    ...
                                    <form class="js-validation-signin" action="{{ route("login") }}" method="POST" novalidate="novalidate">
                                        ...
                                        <div class="py-3">
                                            <div class="mb-4">
                                                <input type="text" class="form-control form-control-alt form-control-lg" id="login-email" name="email" placeholder="Email">
                                            </div>
                                            <div class="mb-4">
                ...
                <div class="fs-sm text-muted text-center">
                    <strong>Cybernaptics</strong> &copy; <span data-toggle="year-copy"></span>
                </div>
            </div>
        </div>
        <!-- END Page Content -->
